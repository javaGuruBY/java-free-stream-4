public class ColorDetectorServiceTest {
    private ColorDetectorService lightColorDetectorService = new ColorDetectorService();
    ...
    public void detectLightColorViolet () {
        ...
        System.out.println((expectedBehaviour).equals(actionResult));
    }
